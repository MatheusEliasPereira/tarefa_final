...
{	sistfunc equacoes1[] = {z0,z1}, equacoes2[] = {z0,z2};
	double y1[] = {1,0}, y2[] = {0,1}, t = a, h = (b-a)/(double)N, beta = exp(-10), solucao1[N], solucao2[N], solucao_geral[N];
	int i = 0;
	FILE *p;
